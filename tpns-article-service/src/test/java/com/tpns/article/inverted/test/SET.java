 ...
 * <p>
 * Even though this implementation include the method <tt>equals()</tt>, it does
 * not support the method <tt>hashCode()</tt> because sets are mutable.
 * <p>
 ...
 * <tt>equals()</tt> or <tt>hashCode()</tt>. The <em>add</em>, <em>contains</em>
 ...
 * <p>
 * This implementation uses a balanced binary search tree. It requires that For
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
	 ...
	 * @param key
	 *            the key
	 * @return <tt>true</tt> if this set contains <tt>key</tt>; <tt>false</tt>
	 *         otherwise
	 * @throws NullPointerException
	 *             if <tt>key</tt> is <tt>null</tt>
	 */
	...
	/**
	 * Removes the specified key from this set (if the set contains the
	 * specified key).
	 *
	 * @param key
	 *            the key
	 ...
	 *
	 * @return <tt>true</tt> if this set is empty; <tt>false</tt> otherwise
	 */
	...
	/**
	 * Returns all of the keys in this set, as an iterator. To iterate over all
	 ...
	 * @param key
	 *            the key
	 * @return the largest key in this set table less than or equal to
	 *         <tt>key</tt>
	 * @throws NullPointerException
	 *             if <tt>key</tt> is <tt>null</tt>
	 * @throws NoSuchElementException
